...
export const en: Translations = {
  ...
  articles: {
    ...
    referencesTitle: 'Reference Links & Bibliography',
    referencesSubtitle: 'Primary sources, official documentation, and technical specifications referenced in this article.',
    readNextTitle: 'Read Next',
    readNextSubtitle: 'Continue exploring other engineering essays and articles on GlassHub.',
    readNextAction: 'Read Article',
